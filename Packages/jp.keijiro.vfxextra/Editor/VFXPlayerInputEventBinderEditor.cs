...
{
    //
    // Custom editor for VFXPlayerInputEventBinder
    //
    // This class provides a drop-down for selecting an action from a specified
    // PlayerInput instance. The event name is automatically determined from
    // the name of the action.
    //
    [CustomEditor(typeof(VFXPlayerInputEventBinder))]
    sealed class VFXPlayerInputEventBinderEditor : Editor
    {
